  ...
  module Facebook
    class OAuth
      ...
      def url_for_oauth_code(options = {})
        ...
        "https://#{API.graph_server}/oauth/authorize?client_id=#{@app_id}&redirect_uri=#{callback}#{scope}#{display}"
      end
      ...
      def url_for_access_token(code, options = {})
        ...
        "https://#{API.graph_server}/oauth/access_token?client_id=#{@app_id}&redirect_uri=#{callback}&client_secret=#{@app_secret}&code=#{code}"
      end
